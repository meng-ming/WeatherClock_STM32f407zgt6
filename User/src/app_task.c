...
void start_task(void* pvParameters)
{
    ...
    {
        LOG_E("OS Object Create Failed! System Halt.");
    ...
    LOG_I("All Tasks Created. System Running...");
    taskEXIT_CRITICAL();
...
static void weather_task(void* pvParameters)
{
    ...
    while (1)
    {
        /* * 等待任务通知 (来自 UART IDLE 中断)
         * pdTRUE: 退出时清零 (二值信号量行为)
         * 10ms:   超时时间，保证状态机能周期性运行
         */
